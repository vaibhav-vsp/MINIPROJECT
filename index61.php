    ...
    <title>Table with database</title><link href="css/bootstrap.min.css" rel="stylesheet">
...
Contact us.</a>
  ...
  <link rel="icon"  href="icon.png" type="image/x-icon">
    ...
    $sql = "SELECT pname,date, time FROM appointment";
    ...
    <script type="text/javascript">
        const searchFun = () =>{
            ...
            let tr = myTable.getElementById('trnm')
