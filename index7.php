...
<html>
<head>
	<title>Help page</title><link href="css/bootstrap.min.css" rel="stylesheet">
...
<body>
	<center><h1><br><br> <mark> -: HELP :- </h1></center><hr>
<br><br><br><br>

<center>

  <a href="patienthelp.php">
  
 <button class="button button1">Patients Help corner</button></a><br>
 <a href="receptionisthelp.php">
<button class="button button2">Receiptionist Help corner</button></a><br>
